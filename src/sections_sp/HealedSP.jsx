// src/sections_sp/HealedSP.jsx
import styles from "./HealedSP.module.css";
import Reveal from "../components/Reveal";

const HEALED_IMG = "/healed/healed-04.png";

export default function HealedSP() {
  return (
    <section
      id="healed_sp"
      className={styles.section}
      aria-labelledby="healed-label_sp"
    >
      <div className={styles.inner}>
        <header className={styles.head}>
          ...
          <Reveal preset="base" y={12} delay={0.04}>
            <h2 id="healed-label_sp" className={styles.title}>
              治癒後の仕上がり
            </h2>
          </Reveal>
        </header>
